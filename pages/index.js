  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      ...
      <div
        ...
        data-aos-anchor="body"
      >
         Stay tuned for the launch of Gradison, which will bring state-of-the-art AI capabilities to your fingertips. Join our waitlist to know when we&#39;re live!
      </div>
      {/* <div
...
function ContentLogo() {
  return (
    <div className="flex flex-col items-center gap-1 pointer-events-none select-none" data-aos="fade-up" data-aos-anchor="body">
      ...
      <div className='text-3xl font-bold tracking-[0.0080em] -mt-4'>
        Gradison
      </div>
    </div>
  )
...
export default function Home() {
  return (
    <>
      <Circle/>
      <div className="w-full h-full flex flex-col justify-center items-center overflow-hidden px-4 relative">
